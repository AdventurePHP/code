   ...
   public function testSetPlaceHolder() {
      ...
      for ($i = 0; $i < self::ITERATIONS; $i++) {
         $template->setPlaceHolders([
               ...
               'label'          => 'APF web site',
               'headline-1'     => 'Headline',
               'sub-headline-1' => 'Sub line',
               'content-2'      => 'This is teaser content!',
               'url-2'          => 'http://adventure-php-framework.org',
               'label-2'        => 'APF web site',
               'headline-3'     => 'Headline',
               'sub-headline-3' => 'Sub line',
               'content-3'      => 'This is teaser content!',
               'url-3'          => 'http://adventure-php-framework.org',
               'label-3'        => 'APF web site'
         ]);
      }
      $end = microtime(true);
