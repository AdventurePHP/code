...
class FrontController extends APFObject {
    ...
    */
   public function start(string $namespace, string $template) {
    ...
    */
   protected function runActions(string $type = Action::TYPE_PRE_PAGE_CREATE) {
    ...
    */
   public function getActionByName(string $actionName) {
    ...
    */
   public function addAction(string $namespace, string $name, array $params = [], string $urlToken = null) {
      ...
      if (empty($inputClass)) {
         $inputClass = FrontControllerActionParameters::class;
      }
      ...
      /* @var $input FrontControllerActionParameters */
    ...
    */
   protected function getActionNamespaceByURLString(string $namespaceUrlRepresentation) {
    ...
    */
   protected function generateParamsFromInputConfig(string $config = null) {
    ...
    */
   public function registerActionUrlMappings(string $namespace, string $name) {
    ...
    */
   public function getActionUrlMapping(string $tokenOrNamespace, string $name = null) {
    ...
    */
   private function sortActions(int $a, int $b) {
