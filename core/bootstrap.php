...
Document::addTagLib(Html5DateFieldTag::class, 'form', 'html5-date');
Document::addTagLib(Html5DateTimeLocalFieldTag::class, 'form', 'html5-date-time');
Document::addTagLib(Html5TimeFieldTag::class, 'form', 'html5-time');
Document::addTagLib(Html5WeekFieldTag::class, 'form', 'html5-week');
Document::addTagLib(Html5MonthFieldTag::class, 'form', 'html5-month');
Document::addTagLib(Html5ColorFieldTag::class, 'form', 'html5-color');
Document::addTagLib(Html5NumberFieldTag::class, 'form', 'html5-number');
Document::addTagLib(Html5PhoneNumberFieldTag::class, 'form', 'html5-tel');
Document::addTagLib(Html5EmailFieldTag::class, 'form', 'html5-email');
Document::addTagLib(Html5UrlFieldTag::class, 'form', 'html5-url');
