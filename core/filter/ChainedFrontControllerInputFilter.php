...
/**
 * @package core::filter
 * @class ChainedFrontControllerInputFilter
 *
 * Implements the front controller input filter for the new filter
 ...
 */
class ChainedFrontControllerInputFilter implements ChainedContentFilter {
