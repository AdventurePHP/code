...
abstract class GlobalExceptionHandler {
    ...
    *
    * @throws Throwable|Exception|Error In case the APF exception handler is disabled, the original exception is thrown.
    *
    * @author Christian Achatz
    * @version
    * Version 0.1, 03.03.2012<br />
    * Version 0.2, 03.03.2018 (Re-introduced strict interface definition.)<br />
    */
