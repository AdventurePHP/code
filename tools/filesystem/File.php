...
class File extends FilesystemItem {
   ...
   /**
    * @private
    * @var string The mime content type of the file
    */
    ...
    * @public
    *
    * @param   string $path A path that will be used as filepath for the new file
    *
    * @author  Nicolas Pecher
   ...
   public function makeDownload() {
      $file = $this->getPath();
      HeaderManager::send('Content-type: ' . $this->getContentType(), true);
      HeaderManager::send('Content-Disposition: attachment; filename="' . $file . '"', true);
      readfile($file);
   }
}
