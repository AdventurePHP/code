...
class UrlFieldTag extends TextFieldTag {
   ...
   public function __construct() {
      ...
      $this->attributeWhiteList[] = 'pattern';
      $this->attributeWhiteList[] = 'required';
   }

   public function transform() {
      if ($this->isVisible) {
         return '<input type="url" ' . $this->getSanitizedAttributesAsString($this->attributes) . ' />';
      }
