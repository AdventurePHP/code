...
class ListDefinitionTag extends AbstractListTag {
   ...
   public function __construct() {
      self::addTagLib(new TagLib('APF\extensions\htmllist\taglib\list_taglib_elem_defterm', 'list', 'elem_defterm'));
      self::addTagLib(new TagLib('APF\extensions\htmllist\taglib\list_taglib_elem_defdef', 'list', 'elem_defdef'));
   }
