...
CREATE TABLE IF NOT EXISTS `entry` (
  ...
  `City` varchar(100) collate latin1_german1_ci NOT NULL default '',
  `Website` varchar(100) collate latin1_german1_ci NOT NULL default '',
  `ICQ` varchar(100) collate latin1_german1_ci NOT NULL default '',
  `MSN` varchar(100) collate latin1_german1_ci NOT NULL default '',
  `Skype` varchar(100) collate latin1_german1_ci NOT NULL default '',
  `AIM` varchar(100) collate latin1_german1_ci NOT NULL default '',
  `Yahoo` varchar(100) collate latin1_german1_ci NOT NULL default '',
  `Text` text collate latin1_german1_ci NOT NULL,
  `Date` date NOT NULL default '0000-00-00',
  `Time` time NOT NULL default '00:00:00',
  PRIMARY KEY  (`EntryID`)
...
CREATE TABLE IF NOT EXISTS `guestbook` (
  ...
  `Admin_Username` varchar(50) collate latin1_german1_ci NOT NULL default '',
  `Admin_Password` varchar(100) collate latin1_german1_ci default NULL,
