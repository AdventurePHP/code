<?php
   ...
   class umgt_add_permission_controller extends permission_base_controller {
      ...
      public function transformContent(){
         ...
         $users = $uM->loadUsersNotWithVisibilityPermissions($proxy);
         ...
         $groups = $uM->loadGroupsNotWithVisibilityPermissions($proxy);
         ...
         if($form->isSent() && $form->isValid()){
            ...
            $uM->attachUsers2VisibilityDefinition($proxy,$this->mapSelectedOptions2DomainObjects('users','User'));
